...
const Homepage = () => {
  ...
  const firstVideo = useBlogData()?.allblogs.filter((blog) => blog.type === 1).reverse().slice(0, 1)[0];
  ...
  const panels = [
    <div className="md:grid grid-cols-2 gap-5" key={0}>
      ...
      <div className="md:p-6 md:shadow-xl rounded">
        <h1 className="text-xl text-[#025CAF] font-semibold">Robotic Knee Replacement</h1>
        <p className="">
          ...
          knee implants, tailored to patient&apos;s unique anatomy. This method
    ...
    <div className="md:grid grid-cols-2 gap-5"  key={1}>
      ...
      <div className="md:p-6 md:shadow-xl rounded">
        <h1 className="text-xl text-[#025CAF] font-semibold">Joint Replacement</h1>
        <p className="">
          Dr. Vasudeva Juvvadi excels in joint replacement surgery in Hyderabad,
          specializing in advanced techniques to hip and knee joints. With
          ...
          journey to improve mobility and quality of life. Recognized for his
          skill and dedication, Dr. Vasudeva is a respected doctor in orthopedic
    ...
    <div className="md:grid grid-cols-2 gap-5" key={2}>
      ...
      <div className="md:p-6 md:shadow-xl rounded">
        <h1 className="text-xl text-[#025CAF] font-semibold">Sports Medicine</h1>
        <p className="">
          Dr. Vasudeva Juvvadi is a distinguished doctor in sports medicine in
          ...
          only healing but also on enhancing athletic performance and preventing
          future injuries. His expertise spans in treating a wide range of sports injuries,
          spanning from ligament tears to joint dislocations, ensuring that athletes receive
          comprehensive and an effective treatment. Known for his compassionate
          demeanor and commitment to excellence, Dr. Vasudeva is dedicated to
          helping athletes at of all levels recover swiftly and safely, enabling
    ...
    <div className="md:grid grid-cols-2 gap-5" key={3}>
      ...
      <div className="md:p-6 md:shadow-xl rounded">
        <h1 className="text-xl text-[#025CAF] font-semibold">General orthopedics</h1>
        <p className="">
          Dr. Vasudeva Juvvadi is highly regarded doctor in general orthopedics in
          ...
          the patient&apos;s specific needs and lifestyle. His dedication to
          excellence and commitment in improving quality of life through
          orthopedic care makes him a trusted choice for individuals seeking
    ...
    <div className="md:grid grid-cols-2 gap-5" key={4}>
      ...
      <div className="md:p-6 md:shadow-xl rounded">
        ...
        <p className="">
          ...
          design tailored rehabilitation programs that addresses their specific
          needs and goals. Whether recovering from surgery, managing chronic
          pain, or enhancing mobility, he emphasizes on a holistic approach to
          physiotherapy that encompasses manual therapy, therapeutic exercises,
          and patient education. Dr. Vasudeva&apos;s expertise and dedication ensures
          ...
          physiotherapy in Hyderabad underscore his commitment to enhance
          ...
          <div className="container lg:max-w-6xl max-w-3xl py-4 mobile-gap-x">
            <div className="md:grid lg:grid-cols-12 grid-cols-6 gap-10 bg-contain items-center max-sm:space-y-4">
              <div className="lg:col-span-5 col-span-4">
                <h3 className="md:text-2xl text-xl font-semibold mb-4 uppercase" data-aos="zoom-in">About Dr. Vasudeva Juvvadi</h3>
                <p className="leading-6 text-content2" data-aos="zoom-in">Best Orthopedic Doctor in Hyderabad - Dr. Vasudeva Juvvadi has 22 years of experience as an Orthopedic doctor in Hyderabad. He is the best knee replacement surgeon in Hyderabad. He is a renowned revision knee and hip and trauma surgeon. He has hands-on experience and expertise in diagnosis, treatment, and management of common and complex Orthopedic conditions. Being the top orthopedic doctor in Hyderabad and with expertise in knee replacement and reconstructive surgery, he regularly deals with complex joint replacement. Dr. Vasudeva is a Consultant Orthopedic and Joint Replacement Surgeon at CITIZENS HOSPITAL, Nallagandla, Hyderabad. The doctor holds a fellowship in joint replacement and has . He worked at best accrediated orthopedic hospital in Gachibowli.</p>
              </div>
            ...
            <div className="md:grid lg:grid-cols-12 lg:gap-20 gap-10">
              <div className="lg:col-span-3 col-span-5" data-aos="fade-up">
                <Heading
                  ...
                  text2={"Departments"}
                />
                <p className="mt-5">Explore our diverse range of departments, each dedicated in providing exceptional services and specialized care.</p>
              </div>
            ...
            <div className="md:grid grid-cols-12 items-center gap-5">
              ...
              <div className="lg:p-8 lg:col-span-8 col-span-9">
                <div className="shadow-orthopedic md:px-4 py-3 rounded space-y-3">
                  <span className="leading-tight bg-[#C3E5FF] px-3 py-2 rounded-xl" data-aos="fade-up">Orthopedic</span>
                  <div className="uppercase md:text-2xl text-lg" data-aos="fade-up">Dr.Vasudeva Juvvadi</div>
                  <table className="divide-y border-t text-sm">
                    <tbody>
                      ...
                      <tr data-aos="fade-up">
                        <td className="text-gray-500 py-3">Profile:</td>
                        <td>
                          Dr. Vasudeva Juvvadi is a Best Orthopedic Doctor
                          practicing at Citizens Hospital. He has a remarkable 22
                          years of experience in this field of Orthopedics. He
                          completed MBBS from the prestigious Dr. NTR University
                          of Health Sciences Andhra Pradesh and MS in Orthopedics
          ...
          <div className="container max-w-6xl md:py-20 lg:grid grid-cols-12">
            <div className="col-span-5">
              <div className="md:pb-5" data-aos="fade-up">
                <Heading
                  heading={"Have a Question? Ask a professional"}
            ...
            <div className="max-w-6xl container">
              ...
              <div className="lg:grid lg:grid-cols-12 md:mx-0 ">
                <div className="col-span-3 mx-4 md:mx-0 max-lg:hidden md:mt-16">
                  ...
                  <h3 className="md:text-2xl text-xl font-semibold py-3">Connect with Dr.Vasudeva Juvvadi</h3>
                  <p className="mb-2 text-[#606060]">Join us for insightful health talks with Dr. Vasudeva Juvvadi. Receive expert advice and the latest in medical field that keep you informed and healthy.</p>
                </div>
