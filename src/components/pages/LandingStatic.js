...
import robotic from "../../assets/images/landing/robotic-knee-hip.png";
...
import faq from "../../assets/images/landing/faq.png";
import doc from "../../assets/images/about/doctor.png";
import mako from "../../assets/images/landing/mako.png";
            ...
            <div className="md:grid grid-cols-12 gap-16">
              ...
              <div className="text-white col-span-4 max-sm:my-6">
                <h3 className="md:text-xl">
                  Best Robotic Knee and Hip Surgeon in Hyderabad
                </h3>
          ...
          <div className="md:grid grid-cols-2 items-center">
            ...
            <div className="">
              <div className="shadow-blog flex max-sm:justify-start items-center md:gap-10 gap-4 border-b p-4 px-8 rounded">
                ...
                <div>
                  <h2 className="mb-3 md:text-lg text-sm">Advanced Robotic Knee
                    Surgeon in Hyderabad</h2>
          ...
          <div className="md:grid grid-cols-2">
            <div>
              <div className="space-y-4">
                <h3 className="text-xl font-medium">What is Robotic Surgery?</h3>
        ...
        <div className="max-w-6xl container mobile-gap-x">
          <div className="md:grid grid-cols-2">
            ...
            <div>
              ...
              <h2 className="text-lg font-medium mb-2">Is Robotic Knee and Hip Surgery safe?</h2>
              ...
              <h2 className="text-lg font-medium my-2">What are the benefits Of Robotic Surgery?</h2>
              ...
              <h2 className="text-lg font-medium my-2">What activities to do after Robotic Knee and Hip Surgery?</h2>
              ...
              <h2 className="text-lg font-medium my-2">When is Robotic Knee and Hip Surgery required?</h2>
              ...
              <h2 className="text-lg font-medium my-2">What is the cost Of Robotic Knee and Hip in India?</h2>
              ...
              <h2 className="text-lg font-medium my-2">What is the cost of Robotic Knee and Hip Surgery in Hyderabad?</h2>
